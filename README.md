...
| etcd | `etcd`                       | **etcd**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-etcd](https://artifacthub.io/packages/helm/cloudpirates-etcd/etcd)                                                                   | —          |                        |
| Ghost | `ghost`                       | **ghost**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-ghost](https://artifacthub.io/packages/helm/cloudpirates-ghost/ghost)                                                                   | —          |                        |
...
| KeyCloak | `keycloak`                       | **keycloak**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-keycloak](https://artifacthub.io/packages/helm/cloudpirates-keycloak/keycloak)                                                                   | —          |                        |
| MariaDB | `mariadb`                       | **mariadb**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-mariadb](https://artifacthub.io/packages/helm/cloudpirates-mariadb/mariadb)                                                                   | —          |                        |
| Memcached | `memcached`                       | **memcached**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-memcached](https://artifacthub.io/packages/helm/cloudpirates-memcached/memcached)                                                                   | —          |                        |
| MinIO | `minio`                       | **minio**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-minio](https://artifacthub.io/packages/helm/cloudpirates-minio/minio)                                                                   | —          |                        |
| MongoDB | `mongodb`                       | **mongodb**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-mongodb](https://artifacthub.io/packages/helm/cloudpirates-mongodb/mongodb)                                                                   | —          |                        |
...
| NginX | `nginx`                       | **nginx**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-nginx](https://artifacthub.io/packages/helm/cloudpirates-nginx/nginx)                                                                   | —          |                        |
...
| Postgres | `postgres`                       | **postgres**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-postgres](https://artifacthub.io/packages/helm/cloudpirates-postgres/postgres)                                                                   | —          |                        |
...
| RabbitMQ Chart | `rabbitmq`                       | **rabbitmq**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-rabbitmq](https://artifacthub.io/packages/helm/cloudpirates-rabbitmq/rabbitmq)                                                                   | —          |                        |
| RabbitMQ Operator | `rabbitmq-cluster-operator`                       | **rabbitmq-cluster-operator**                                | CloudPirates          | Operator    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-rabbitmq-cluster-operator](https://artifacthub.io/packages/helm/cloudpirates-rabbitmq-cluster-operator/rabbitmq-cluster-operator)                                                                   | —          |                        |
...
| Redis | `redis`                       | **redis**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-redis](https://artifacthub.io/packages/helm/cloudpirates-redis/redis)                                                                   | —          |                        |
| RustFS | `rustfs`                       | **rustfs**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-rustfs](https://artifacthub.io/packages/helm/cloudpirates-rustfs/rustfs)                                                                   | —          |                        |
...
| TimescaleDB | `timescaledb`                       | **timescaledb**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-timescaledb](https://artifacthub.io/packages/helm/cloudpirates-timescaledb/timescaledb)                                                                   | —          |                        |
| Valkey | `valkey`                       | **valkey**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-valkey](https://artifacthub.io/packages/helm/cloudpirates-valkey/valkey)                                                                   | —          |                        |
| Zookeeper | `zookeeper`                       | **zookeeper**                                | CloudPirates          | Chart    | [https://artifacthub.io/packages/helm/cloudpirates/cloudpirates-zookeeper](https://artifacthub.io/packages/helm/cloudpirates-zookeeper/zookeeper)                                                                   | —          |                        |
